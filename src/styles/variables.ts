...
export const $buttonPrimaryHoverColor = 'rgba(0, 123, 255, 1)';
...
export const $headerBackgroundColor = '#ce7bd1';
export const $footerBackgroundColor = '#ce7bd1';
export const $headerBackgroundColorDark = '#963999';
export const $footerBackgroundColorDark = '#963999';
...
export const $borderColorPrimary = '#00cafd';
